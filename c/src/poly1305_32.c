...
void o1c_poly1305_key_setup(o1c_poly1305_t ctx, const uint8_t k[o1c_poly1305_KEY_BYTES]) {
    poly1305_state_internal_s *st = (poly1305_state_internal_s *) ctx->state;
...
void o1c_poly1305_final(o1c_poly1305_t ctx, uint8_t t[o1c_poly1305_TAG_BYTES]) {
    poly1305_state_internal_s *st = (poly1305_state_internal_s *) ctx->state;
