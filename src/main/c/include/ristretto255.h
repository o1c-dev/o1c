...
#define o1c_ristretto255_SEED_BYTES 32

O1C_EXPORT void o1c_ristretto255_sign(uint8_t sig[o1c_ristretto255_SIGN_BYTES], const uint8_t *m, size_t m_len,
                                      const uint8_t seed[o1c_ristretto255_SEED_BYTES]);

O1C_EXPORT bool o1c_ristretto255_verify(const uint8_t sig[o1c_ristretto255_SIGN_BYTES], const uint8_t *m, size_t m_len,
